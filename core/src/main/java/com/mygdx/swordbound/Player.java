...
public class Player extends WalkingCharacter
{
    ...
    public void act(float delta) {
        ...
        if(dead) {
            ...
            // Movimiento horizontal incluso en el aire
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        float offset = (spriteWidth - getWidth()) / 2f;
        batch.draw(currentFrame,
            getX() - getWidth()/2f - map.scrollX - offset,
            getY() - getHeight()/2f,
            spriteWidth, 128, 0, 0, 669, 569, lookLeft, true);
